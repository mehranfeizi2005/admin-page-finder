...
#Fancy banner :p
print ('''\033[1;34m
1111    1111    00000     22   22   111        11        33    33   
11 11 11  11    0         22   22  1   1      11 11      333   33  
11  11    11    00000     2222222  1111      11   11     33  3 33  
11        11    0         22   22  11       111111111    33   333  
11        11    00000     22   22  1 1     11       11   33    33   
                                                             \033[37mMade with \033[91m<3\033[37m By D3V\033[1;m''')

print ('''\n  I am not responsible for your shit and if you get some error while
 running adminpagefinder, there are good chances that target isn't responding.\n''')
print ('\033[1;31m--------------------------------------------------------------------------\033[1;m\n')

try:
	target = target.replace('https://', '') #Removes https://
except:
	print ('\033[1;31m[-]\033[1;m -u argument is not supplied. Enter python adminpagefinder.py -h for help')
	quit()
